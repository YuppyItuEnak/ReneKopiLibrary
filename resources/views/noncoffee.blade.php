...
<div style="background: #3f4e4f">
    ...
    <div class="container text-center ">
        <div class="row ">
            @foreach ($noncoffees as $noncoffee)
                <div class="col-auto col-md-4 mx-auto ">
                    <div class="card my-4 mx-auto" style="height: 23rem; width: 16rem; background-color:#dcd7c9;">
                        <img src="{{ $noncoffee['image'] }}" class="card-img-top" style=" height: 230px" alt="Product picture">
                        <div class="card-body">
                            <h5 class="card-title" style=" font-family: 'Florentia', sans-serif;
                            ">{{ $noncoffee['name'] }}</h5>
                            <div class="d-flex placeholder-glow">
                                <a href="/noncoffees/{{ $noncoffee['code'] }}" style="background-color: #3f4e4f; color: #ffffff"  class="btn align-items-center justify-content-center mx-auto">
                                    Details
