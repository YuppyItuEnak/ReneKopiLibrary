    ...
    <section id="home">
                ...
                <div class="textover">
                    ...
                    <ul class="section-btn ">
                        <a href="#product" type="button"
                            class="btn btn-outline-secondary btn-lg col-md-6 offset-md-3 text-white">
                            Discover More
        ...
        <section id="about" class="bg-black">
            ...
            <div class="text-center">
                ...
                <p class="fs-5 text-white">Get in touch with us for more information <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16" >
                        ...
                        <div class=" col-12 col-md-4 mx-auto mt-4">
                            <h3 class="text-center text-white">
                                <a href="tel:+6289677889969">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="phone bi bi-telephone text-white d-flex justify-content-sm-center mx-auto" viewBox="0 0 16 16">
